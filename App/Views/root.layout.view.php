...
<head>
    ...
    <link rel="stylesheet" href="semestralka/bootstrap-4.5.3-dist/css/bootstrap.min.css">
    ...
    <script src="semestralka/jquery/jquery-3.5.1.slim.min.js"></script>

    <?= $contentHTML ?>

    <script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.12.9/umd/popper.min.js" integrity="sha384-ApNbgh9B+Y1QKtv3Rn7W3mgPxhU9K/ScQsAP7hUibX39j7fakFPskvXusvfa0b4Q" crossorigin="anonymous"></script>
    <script src="semestralka/bootstrap-4.5.3-dist/js/bootstrap.bundle.min.js"></script>
    </body>
</html>
